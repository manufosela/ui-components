...
/**
 * Canvas-based regular polygon renderer.
 *
 * @element canvas-polygon
 *
 * @attr {Number} size - Canvas size in pixels (default: 400)
 * @attr {Number} sides - Number of polygon sides (>= 3, default: 6)
 * @attr {Number} line-width - Stroke line width (default: 1)
 * @attr {String} bg-color - Fill color (default: transparent)
 * @attr {Number} offset-rotation - Rotation offset in radians (default: auto)
 *
 * @cssprop [--canvas-polygon-text-color=#000] - Host text color
 */
...
customElements.define('canvas-polygon', CanvasPolygon);
